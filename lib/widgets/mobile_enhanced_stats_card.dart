...
class MobileEnhancedStatsCard extends StatefulWidget {
  final IconData icon;
  final String title;
  final String value;
  ...
  @override
  State<MobileEnhancedStatsCard> createState() => _MobileEnhancedStatsCardState();
}

class _MobileEnhancedStatsCardState extends State<MobileEnhancedStatsCard>
